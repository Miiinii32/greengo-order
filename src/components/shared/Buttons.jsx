...
const buttonVariants = cva(
  /* layout */
  "group/button inline-flex shrink-0 items-center justify-center rounded-md bg-clip-padding font-medium whitespace-nowrap transition-all outline-none select-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 active:translate-y-px disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 hover:pointer-events-auto",
  {
    variants: {
      variant: {
        default: 'bg-primary text-on-primary hover:bg-primary-dim/90',
        outline:
        ...
        secondary:
          'bg-surface-dim text-on-surface-light hover:bg-on-surface/12 aria-expanded:bg-surface-dim aria-expanded:text-primary',
        ghost:
