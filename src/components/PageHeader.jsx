...
export const PageHeader = ({ title, typeSelect, launchStateSelect, addText }) => {
  return (
    <header className="flex h-auto shrink-0 items-center gap-2 border-b border-border bg-surface shadow-sm  transition-[width,height] ease-linear group-has-data-[collapsible=icon]/sidebar-wrapper:h-(--header-height)">
