...
function FieldLegend({ className, variant = 'legend', ...props }) {
  return (
    <legend
      ...
      className={cn(
        /* legend style */
        'data-[variant=legend]:text-lg data-[variant=legend]:font-medium data-[variant=legend]:text-on-surface data-[variant=legend]:mb-6!',
        /* label style */
        'data-[variant=label]:text-sm data-[variant=label]:font-semibold data-[variant=label]:text-on-surface-light data-[variant=legend]:mb-2',
        className,
      )}
      {...props}
    />
